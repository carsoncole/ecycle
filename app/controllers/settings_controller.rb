class SettingsController < ApplicationController
  ...
  private
    ...
    def setting_params
      params.require(:setting).permit(:dropoff_start_date, :dropoff_end_date, :pickup_start_date, :pickup_end_date, :pickup_instructions, :is_pickup_signups_enabled, :pickup_contact_name, :pickup_contact_email, :general_contact_name, :general_contact_email, :donations_enabled, :allow_user_signups, :pickups_start_at, :pickups_end_at, :dropoffs_start_at, :dropoffs_end_at, :send_admin_pickup_notifications, :event_date, :dropoff_location, :brief_marketing_message, :is_pickups_offered, :is_donations_offered)
    end
end
